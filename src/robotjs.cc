...
static KeyNames key_names[] =
{
	...
	{ "Control",        K_CONTROL }, //else .code maps to this line
	{ "ControlLeft",    K_LEFT_CONTROL }, //needs .code instead of .key
	{ "ControlRight",   K_RIGHT_CONTROL },  //needs .code instead of .key
	{ "Shift",          K_SHIFT },
